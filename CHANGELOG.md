...
- Promote the Marketplace Plugin to `0.7.29` and pin its Codex and Claude Code
  MCP definitions and Skill fallbacks to `@kyo-so/cli@0.16.20`.
...
- Promote the Marketplace Plugin to `0.7.28` and pin its Codex and Claude Code
  MCP definitions and Skill fallbacks to `@kyo-so/cli@0.16.19`.
...
- Promote the Marketplace Plugin to `0.7.27` and pin its Codex and Claude Code
  MCP definitions and Skill fallbacks to `@kyo-so/cli@0.16.18`.
...
- Promote the Marketplace Plugin to `0.7.26` and pin its Codex and Claude Code
  MCP definitions and Skill fallbacks to `@kyo-so/cli@0.16.17`.
...
- Promote the Marketplace Plugin to `0.7.25` and pin its Codex and Claude Code
  MCP definitions and Skill fallbacks to `@kyo-so/cli@0.16.16`.
...
- Update Safe Chain to `1.5.17`.

- Promote the Marketplace Plugin to `0.7.23` and pin its Codex and Claude Code
  MCP definitions and Skill fallbacks to `@kyo-so/cli@0.16.14`.
...
- Promote the Marketplace Plugin to `0.7.21` and pin its Codex and Claude Code
  MCP definitions and Skill fallbacks to `@kyo-so/cli@0.16.12`.
- Update Zod to `4.5.1`.
...
- Promote the Marketplace Plugin to `0.7.20` and pin its Codex and Claude Code
  MCP definitions and Skill fallbacks to `@kyo-so/cli@0.16.11`.
...
- Promote the Marketplace Plugin to `0.7.16` and pin its Codex and Claude Code
  MCP definitions and Skill fallbacks to `@kyo-so/cli@0.16.8`.
- Update the default Codex ACP adapter to
